...
public class Controller27 {
    ...
    @PostMapping("sub1")
    public String sub2(String username, MultipartFile upload) {
    ...
    @PostMapping("sub2")
    public String sub4(String username, MultipartFile uploadFile) {
        service9.action2(username, uploadFile);
        return "redirect:/main27/sub1";
    }
