...
public class Service3 {
    ...
    public void action16(LocalDate start, LocalDate end) {
        // SELECT * FROM employee WHERE birth_date BETWEEN :start AND :eed
    ...
    public void action18() {
        ...
        System.out.println("========================================");
        List<Entity19> byPriceBetween = entity19Repository.findByPriceBetween(1.5, 30.2);
        for (Entity19 entity19 : byPriceBetween) {
            System.out.println(entity19);
        }
        System.out.println("========================================");
        List<Entity19> byPriceMoreThan = entity19Repository.findByPriceGreaterThan(10.4);
        for (Entity19 entity19 : byPriceMoreThan) {
            System.out.println(entity19);
        }
        System.out.println("========================================");
        List<Entity19> byCategoryId1 = entity19Repository.findByCategoryIdIn(List.of(1, 2, 3));
        for (Entity19 entity19 : byCategoryId1) {
            System.out.println(entity19);
        }
        System.out.println("========================================");
        List<Entity19> or = entity19Repository.findByProductNameContains("or");
        for (Entity19 entity19 : or) {
            System.out.println(entity19);
        }
        System.out.println("========================================");
        List<Entity19> byProductNameLike = entity19Repository.findByProductNameLike("%or%");
